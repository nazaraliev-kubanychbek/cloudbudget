(function (e) {
    ...
    var c = {}, d = {
        ...
        b = '<style id="css-ddslick" type="text/css">' +
            ...
            '.dd-selected{ overflow:hidden; padding:10px; display: flex; align-items: center}' +
            ...
            '.dd-option{ height: 52px; padding:10px; display:flex; align-items: center; overflow:hidden; text-decoration:none; color:#333; cursor:pointer;-webkit-transition: all 0.25s ease-in-out; -moz-transition: all 0.25s ease-in-out;-o-transition: all 0.25s ease-in-out;-ms-transition: all 0.25s ease-in-out; }' +
